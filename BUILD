...
grpc_cc_library(
    ...
    srcs = [
        ...
        # "src/core/lib/iomgr/ib_client_posix.cc",
        # "src/core/lib/iomgr/ib_client.cc",
        # "src/core/lib/iomgr/ib_server.cc",
        # "src/core/lib/iomgr/ib_server_posix.cc",
        # "src/core/lib/iomgr/rdma_cm.cc",
        # "src/core/lib/iomgr/rdma_utils_posix.cc",
        # "src/core/lib/iomgr/rdma_memory_management.cc",
...
cc_library(
    ...
    hdrs=[
        ...
        "src/core/lib/iomgr/endpoint.h",
        "src/core/lib/iomgr/pollset.h",
        "build-lib/include/rdma/rdma_cma.h",
        "build-lib/include/rdma/rdma_verbs.h",
        "src/core/lib/iomgr/closure.h",
        "src/core/lib/gprpp/time.h",
        "src/core/lib/iomgr/tcp_server.h",
        "src/core/lib/iomgr/pollset_set.h",
        ...
        "src/core/lib/channel/channel_args.h",
        "src/core/lib/resource_quota/api.h",
    ]+GRPC_PUBLIC_HDRS+GRPC_PUBLIC_EVENT_ENGINE_HDRS,
    linkopts=["-libverbs","-lrdmacm"],
    deps=[
        "gpr_base",
        "iomgr_port",
        "slice_refcount",
...
cc_import(
    name="rdmacm",
    interface_library="build-lib/lib/librdmacm.so",
    system_provided=1,
)
